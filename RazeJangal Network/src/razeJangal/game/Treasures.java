...
public class Treasures implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7016008768539933807L;
	private Random rnd = new Random();
	public int[] treasureIndex = new int[0];
	public String[] treasureName = new String[0];
	private boolean[] eatenTreasure;
	public int goalTreasure;
